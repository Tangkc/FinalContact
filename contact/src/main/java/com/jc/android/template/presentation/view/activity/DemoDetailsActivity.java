...
import com.jc.android.template.presentation.view.fragment.DemoDetailsFragment;

/**
 * Activity that shows details of a certain user.
 */
public class DemoDetailsActivity extends BaseActivity {
	...
	public static Intent getCallingIntent(Context context, int userId) {
		Intent callingIntent = new Intent(context, DemoDetailsActivity.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		DataBindingUtil.setContentView(this, R.layout.activity_demo_details);
	...
	private void initializeActivity(Bundle savedInstanceState) {
		if (savedInstanceState == null) {
			...
			addFragment(R.id.fl_fragment_demo, DemoDetailsFragment.newInstance(this.userId), DemoDetailsFragment.TAG);
		} else {
