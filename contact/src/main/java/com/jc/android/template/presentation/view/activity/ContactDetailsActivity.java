...
import com.jc.android.template.presentation.view.fragment.ContactDetailsFragment;
...
public class ContactDetailsActivity extends BaseActivity {
	...
	private void initializeActivity(Bundle savedInstanceState) {
		if (savedInstanceState == null) {
			...
			addFragment(R.id.fl_fragment_demo, ContactDetailsFragment.newInstance(this.userId), ContactDetailsFragment.TAG);
		} else {
